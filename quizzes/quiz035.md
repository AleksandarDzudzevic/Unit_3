![](https://github.com/AleksandarDzudzevic/Unit_3/blob/main/quiz035text.png)
```.py 
import random
class Account:
    def __init__(self):
    ...
    def set_holder_name(self,name):
        ...
        temp = f"Holder's name is {self.holder_name}"
        return temp

    def set_holder_email(self,email):
        self.holder_email = email
        temp = f"Holder's email is {self.holder_email}"
        return temp
    ...
    def deposit(self,amount:int):
        ...
        return temp
```
![](https://github.com/AleksandarDzudzevic/Unit_3/blob/main/quiz035test.jpeg)
